...
<div id="w0" class="list-view directory-list-view"><div class="row row-cards row-deck">
    ...
    <a href="/userprofile/{{ $mut[0]->id }}" class="user-photo" data-pjax="0">
        <div class="card-img-top-wrapper d-flex justify-content-center">
            ...
            <img class="card-img-top" src="{{asset('images')}}/{{ $mut[0]->prfl_photo_path }}" alt="{{ $mut->first()->name }}">
        </div>
            </a>
    <div class="card-body d-flex flex-column" style="position: relative">
        <h4 class="d-flex justify-content-start align-items-center">
            <a href="/userprofile/{{ $mut->first()->id }}" data-pjax="0">
                <span class="display-name">{{ $mut->first()->name }}, {{ $mut->first()->age }}</span>
            </a>
                                    <div class="ml-auto">
        ...
        <div class="text-muted">{{ $mut->first()->country }}</div>
    </div>
</div>
</div>
@endforeach
