  ...
  <div>
    <div>
      ...
      <div class="modal-body">
        ...
        <form action="/u/edittodolistaction" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
        ...
        <div class="form-group mb-2">
        <img style='width:200px;' src='https://globallove.online/images/to_do_globallove_img/{{ $data[0]->to_do_list_image }}'>
        ...
        @php
          $reciepent = DB::table('admin_to_do_list_reciepent')->get();
