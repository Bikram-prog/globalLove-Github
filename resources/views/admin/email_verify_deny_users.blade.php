    ...
    <table style="width:848px;margin:auto">
        ...
        <tr>
            <td style="text-align:center">
                ...
                font: normal normal normal 22px/43px Poppins;padding:30px 50px">Your request for profile verification has been denied.Please re-upload proper documents.</p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
