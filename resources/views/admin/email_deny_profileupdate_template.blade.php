...
<body>
    <table style="width:848px;margin:auto">
        ...
        <tr>
            ...
            letter-spacing: 0px;
            color: #FFFFFF;">Profile Update<p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
                <p style="text-align: center;
                font: normal normal normal 22px/43px Poppins;padding:30px 50px">Your profile text update <i>({{$text[0]->metas_new_value}})</i> is denied by our review team.</p>

                <p style="text-align: center;
                font: normal normal normal 22px/43px Poppins;padding:10px;">Reason: {{ $reason }}</p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
