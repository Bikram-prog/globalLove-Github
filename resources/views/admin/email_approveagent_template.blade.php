...
<body>
    <table style="width:848px;margin:auto">
        ...
        <tr>
            ...
            letter-spacing: 0px;
            color: #FFFFFF;">Agent Application Approved<p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
                <p style="text-align: center;
                font: normal normal normal 22px/43px Poppins;padding:30px 50px">Your agent  application is approved by our review team.</p>
                 <p style="text-align: center;
                font: normal normal normal 22px/43px Poppins;padding:30px 50px"> Agent Code: GL{{$text[0]->id}}</p>       
