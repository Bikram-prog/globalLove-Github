    ...
    <div id="sidepanel">
        <div id="profile">
            <div class="wrap">
              ...
              @if($propic->prfl_approve_status == '1')
                <img id="profile-img" src="{{ $propic->prfl_photo_path }}" class="online" alt="" />
                @else
                <img id="profile-img" src="{{ $propic->prfl_photo_path }}" class="online" alt="" />
                @endif
              @endforeach
                <p><?php echo 'Customer Service'; ?></p>
...
function newMessage() {
    ...
    em = $("#emchat").val()
    if(too != '') {
        socket.emit('send_msg_server', { user: em, msg: message, to: <?php echo '0'; ?>}); //socket
