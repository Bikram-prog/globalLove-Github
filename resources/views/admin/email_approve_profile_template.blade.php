...
<body>
    <table style="width:848px;margin:auto">
        ...
        <tr>
            ...
            letter-spacing: 0px;
            color: #FFFFFF;">Welcome to Global Love!<p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
                <p style="text-align: center;
                font: normal normal normal 22px/43px Poppins;padding:30px 50px">Congratulations, your profile has been approved, please be aware that if you add or replace your profile pics, or change your comments on your profile, your account will be reviewed each and every time.</p>
            </td>
        </tr>
        <tr>
            <td style="text-align:center">
