...
/* generated by https://loading.io/ */
  ...
  <body>
    ...
    <div class="container-lg mt-4 globalA">
      <div class="row mb-2">
        <div class="col-md-12">
          <h2>Todo List <a href="/u/to_do_logout" class="btn btn-outline-danger btn-sm"><span style="float: right; cursor: pointer;">Logout</span></a> <span id="theme_chng" style="float: right; cursor: pointer; margin-left:200px;"><i style="font-size: 22px;" class="fas fa-moon"></i></span></h2>
        </div>
      </div>
      <div class="row mb-2">
        <div class="col-md-8">
    ...
    @if(Crypt::decryptString($_COOKIE['UserStatusToDo']) == '1')
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="/u/addtodolistpost" method="POST" id="addtodo_form2" enctype="multipart/form-data">
          {{ csrf_field() }}
...
<div class="modal fade" id="contact_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    ...
    function all_reciepent(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/all-reciepent", function(results){
    ...
    function delete_rec(id) {
      ...
      if(conf) {
        $.get("/u/del-reciepent/"+ id , function(result){
    ...
    function open_todo(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/opentodo", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='https://www.globallove.online/images/to_do_globallove_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
                var img ="";
              }
    ...
    function in_prog_todo(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/inprogtodo", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='<a href='https://www.globallove.online/images/to_do_globallove_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
                var img ="";
              }
    ...
    function delay_todo(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/delaytodo", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='https://www.globallove.online/images/to_do_globallove_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
    ...
    function delete_todo(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/del-todo/"+ id , function(result){
    ...
    function edit_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        window.location.href= '/u/edit-to-do-list/' +id
      } else {
        return false;
      }
    ...
    function in_prog_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/in-prog-todo/"+ id , function(result){
    ...
    function delay_prog_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/delay-todo/"+ id , function(result){
    ...
    function complete_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/complete-todo/"+ id , function(result){
    ...
    function complete_todo(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/completetodo", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='https://www.globallove.online/images/to_do_globallove_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
