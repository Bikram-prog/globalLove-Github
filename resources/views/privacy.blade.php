@include('common/header') 
  ...
  <div class="container">
  <div class="row">
        <div class="col-md-6 mt-3"><a href="{{ url('/') }}"><img class="signup-logo" src="{{ asset('images/global-love-logo-dark@2x.png') }}" alt="Global Love Logo"></a></div>
        <div class="col-md-6 mt-5 button-terms">
                        <a href="{{ url('signup') }}"><button class="btn button-started btn-danger hero__btn rounded-0 me-2 mb-3">
                        <span class="me-3">GET STARTED FREE</span>
                        <img src="{{ asset('images/icon_arrow.svg') }}" alt="arrow" />
                        </button></a>

                        <a href="{{ url('login') }}"><button class="btn btn-dark hero__btn button-login rounded-0 border-rad mb-3">
