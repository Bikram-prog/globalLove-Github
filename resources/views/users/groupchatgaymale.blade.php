   ...
   <div class="container">
    <div class="row mb-2">
      <div class="col-md-9 text-center">
       ...
       <a href="/group-chat/gm" class="btn btn-success mt-2" style="color: #fff;font-size:15px;margin-left: 20px;">Gay Chat</a>
...
window.addEventListener('beforeunload', function(e) {
  ...
  socket.emit('group_online', {
         ...
         socket.on("group_online_offline_status_server", function(data) {
           if(data.data.status == 'online' && data.data.gname == 'Gay'){
            $('.toast_notify').show();
