...
<form action= "/mobprofiledetailsaction" method="POST">
    {{ csrf_field() }}
    @if (Session::has('msg'))
...
<h4>What do you do for fun / entertainment?</h4><hr>
   ...
   <div class="form-group">
       <h4>What sort of food do you like?</h4><hr>
   ...
   <div class="form-group">
       <h4>What sort of music are you into??</h4><hr>
    ...
    <div class="form-group">
       <h4>What sports do you play or like to watch?</h4><hr>
    ...
    <button type="submit" class="btn btn-primary btn-block" style=" margin-bottom: 30px;">Submit</button>
