...
<body>
    <table style="width:848px;margin:auto">
        ...
        <tr>
            ...
            letter-spacing: 0px;
            color: #000;">Chat Moderator Transscript<p>
            </td>
        </tr>
        <tr>
            ...
            @php  
            $name_user= DB::select("SELECT * FROM users WHERE id= '".$frm->mod_from_id."'");
            

            @endphp
                <pre style="text-align: left;"><b>{{ $name_user[0]->name }}:</b> 
                <br><b>Message: </b>{{ $frm->mod_chat_msg }}
                </pre>
            @endforeach
            </td>
        </tr>
