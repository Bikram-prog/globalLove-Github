   ...
   <div class="container">
    <div class="row mb-2">
      <div class="col-md-9 text-center">
       ...
       <a href="/group-chat/gf" class="btn btn-warning mt-2" style="color: #fff;font-size:15px;margin-left: 20px;">Lesbian Chat</a>

       <a href="/group-chat/gm" class="btn btn-warning mt-2" style="color: #fff;font-size:15px;margin-left: 20px;">Gay Chat</a>

       <a href="/group-chat/transexual" class="btn btn-success mt-2" style="color: #fff;font-size:15px;margin-left: 20px;">Transexual Chat</a>
      </div>
...
window.addEventListener('beforeunload', function(e) {
  ...
  socket.emit('group_online', {
         ...
         socket.on("group_online_offline_status_server", function(data) {
           if(data.data.status == 'online' && data.data.gname == 'Transexual'){
            $('.toast_notify').show();
...
setInterval(function(){
  $.ajax({
                    url: '/group-chat-online-transexual', 
                    datatype: 'json',
